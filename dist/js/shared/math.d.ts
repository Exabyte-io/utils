...
declare const _default: {
    ...
    complex: {
        (arg?: string | mathjs.MathNumericType | mathjs.PolarCoordinates | undefined): Complex;
    ...
    polynomialRoot: (constantCoeff: number | Complex, linearCoeff: number | Complex, quadraticCoeff?: number | Complex | undefined, cubicCoeff?: number | Complex | undefined) => (number | Complex)[];
    ...
    cbrt: {
        (x: Complex, allRoots?: boolean | undefined): Complex;
    ...
    exp: <T_15 extends number | Complex | mathjs.BigNumber>(x: T_15) => T_15;
    expm1: <T_16 extends number | Complex | mathjs.BigNumber>(x: T_16) => T_16;
    gcd: {
    ...
    log: <T_22 extends number | Complex | mathjs.BigNumber>(x: T_22, base?: number | Complex | mathjs.BigNumber | undefined) => mathjs.NoLiteralType<T_22>;
    log10: <T_23 extends number | Complex | mathjs.BigNumber | mathjs.MathCollection>(x: T_23) => T_23;
    log1p: <T_24 extends number | Complex | mathjs.BigNumber | mathjs.MathCollection>(x: T_24, base?: number | Complex | mathjs.BigNumber | undefined) => T_24;
    log2: <T_25 extends number | Complex | mathjs.BigNumber | mathjs.MathCollection>(x: T_25) => T_25;
    multiply: {
    ...
    norm: (x: number | Complex | mathjs.BigNumber | mathjs.MathCollection, p?: string | number | mathjs.BigNumber | undefined) => number | mathjs.BigNumber;
    nthRoot: (a: number | Complex | mathjs.BigNumber | mathjs.MathCollection, root?: number | mathjs.BigNumber | undefined) => number | Complex | mathjs.MathCollection;
    pow: (x: mathjs.MathType, y: number | Complex | mathjs.BigNumber) => mathjs.MathType;
    sign: <T_31 extends mathjs.MathType>(x: T_31) => T_31;
    sqrt: {
        (x: number): number | Complex;
        <T_32 extends Complex | mathjs.BigNumber | mathjs.Unit>(x: T_32): T_32;
    };
    ...
    arg: {
        ...
        (x: Complex | mathjs.BigNumber): mathjs.BigNumber;
        <T_48 extends mathjs.MathCollection>(x: T_48): T_48;
    };
    conj: <T_49 extends number | Complex | mathjs.BigNumber | mathjs.MathCollection>(x: T_49) => mathjs.NoLiteralType<T_49>;
    im: {
        (x: mathjs.MathJsChain<number | Complex>): mathjs.MathJsChain<number>;
    ...
    and: (x: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection, y: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection) => boolean | mathjs.MathCollection;
    not: (x: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection) => boolean | mathjs.MathCollection;
    or: (x: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection, y: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection) => boolean | mathjs.MathCollection;
    xor: (x: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection, y: number | Complex | mathjs.BigNumber | mathjs.Unit | mathjs.MathCollection) => boolean | mathjs.MathCollection;
    ...
    inv: <T_55 extends number | Complex | mathjs.MathCollection>(x: T_55) => mathjs.NoLiteralType<T_55>;
    ...
    rotationMatrix: <T_60 extends mathjs.MathCollection>(theta?: number | Complex | mathjs.BigNumber | mathjs.Unit | undefined, axis?: T_60 | undefined, format?: "sparse" | "dense" | undefined) => T_60;
    ...
    rotate: <T_63 extends mathjs.MathCollection>(w: T_63, theta: number | Complex | mathjs.BigNumber | mathjs.Unit, v?: T_63 | undefined) => T_63;
    size: (x: string | number | boolean | Complex | mathjs.Unit | mathjs.MathCollection) => mathjs.MathCollection;
    ...
    gamma: <T_72 extends number | Complex | mathjs.BigNumber>(n: T_72) => mathjs.NoLiteralType<T_72>;
    kldivergence: (q: mathjs.MathCollection, p: mathjs.MathCollection) => number;
    lgamma: <T_73 extends number | Complex>(n: T_73) => mathjs.NoLiteralType<T_73>;
    ...
    zeta: <T_91 extends number | Complex | mathjs.BigNumber>(s: T_91) => T_91;
    ...
    acos: {
        (x: number): number | Complex;
        <T_107 extends Complex | mathjs.BigNumber>(x: T_107): T_107;
    };
    acosh: {
        (x: number): number | Complex;
        <T_108 extends Complex | mathjs.BigNumber>(x: T_108): T_108;
    };
    acot: {
        (x: number): number;
        <T_109 extends Complex | mathjs.BigNumber>(x: T_109): T_109;
    };
    acoth: {
        (x: number): number;
        <T_110 extends Complex | mathjs.BigNumber>(x: T_110): T_110;
    };
    acsc: {
        (x: number): number | Complex;
        <T_111 extends Complex | mathjs.BigNumber>(x: T_111): T_111;
    };
    acsch: {
        (x: number): number;
        <T_112 extends Complex | mathjs.BigNumber>(x: T_112): T_112;
    };
    asec: {
        (x: number): number | Complex;
        <T_113 extends Complex | mathjs.BigNumber>(x: T_113): T_113;
    };
    asech: {
        (x: number): number | Complex;
        <T_114 extends Complex | mathjs.BigNumber>(x: T_114): T_114;
    };
    asin: {
        (x: number): number | Complex;
        <T_115 extends Complex | mathjs.BigNumber>(x: T_115): T_115;
    };
    asinh: <T_116 extends number | Complex | mathjs.BigNumber>(x: T_116) => T_116;
    atan: <T_117 extends number | Complex | mathjs.BigNumber>(x: T_117) => T_117;
    atan2: <T_118 extends number | mathjs.MathCollection>(y: T_118, x: T_118) => T_118;
    atanh: {
        (x: number): number | Complex;
        <T_119 extends Complex | mathjs.BigNumber>(x: T_119): T_119;
    };
    cos: {
        (x: number | mathjs.Unit): number;
        <T_120 extends Complex | mathjs.BigNumber>(x: T_120): T_120;
    };
    cosh: {
        (x: number | mathjs.Unit): number;
        <T_121 extends Complex | mathjs.BigNumber>(x: T_121): T_121;
    };
    cot: {
        (x: number | mathjs.Unit): number;
        <T_122 extends Complex | mathjs.BigNumber>(x: T_122): T_122;
    };
    coth: {
        (x: number | mathjs.Unit): number;
        <T_123 extends Complex | mathjs.BigNumber>(x: T_123): T_123;
    };
    csc: {
        (x: number | mathjs.Unit): number;
        <T_124 extends Complex | mathjs.BigNumber>(x: T_124): T_124;
    };
    csch: {
        (x: number | mathjs.Unit): number;
        <T_125 extends Complex | mathjs.BigNumber>(x: T_125): T_125;
    };
    sec: {
        (x: number | mathjs.Unit): number;
        <T_126 extends Complex | mathjs.BigNumber>(x: T_126): T_126;
    };
    sech: {
        (x: number | mathjs.Unit): number;
        <T_127 extends Complex | mathjs.BigNumber>(x: T_127): T_127;
    };
    sin: {
        (x: number | mathjs.Unit): number;
        <T_128 extends Complex | mathjs.BigNumber>(x: T_128): T_128;
    };
    sinh: {
        (x: number | mathjs.Unit): number;
        <T_129 extends Complex | mathjs.BigNumber>(x: T_129): T_129;
    };
    tan: {
        (x: number | mathjs.Unit): number;
        <T_130 extends Complex | mathjs.BigNumber>(x: T_130): T_130;
    };
    tanh: {
        (x: number | mathjs.Unit): number;
        <T_131 extends Complex | mathjs.BigNumber>(x: T_131): T_131;
    };
