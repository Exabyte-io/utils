...
# ```
# 4. Copy the wheel file name (or use the full URL provided later)
# 5. Run the server with `python wheel_server.py`
# The server will be available at http://localhost:8080 (or the next available port),
...
# The script will output the URL to use in the notebook or `config.yml` file.
